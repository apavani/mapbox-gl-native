...
/**
 The size of the output image. Minimum is 64x64 pixels.
 */
...
/**
 ...
 Calling this method makes the snapshotter unable to resume after. In order
 to get a snapshot it will be required create a new instance.
 */
- (void)cancel;
